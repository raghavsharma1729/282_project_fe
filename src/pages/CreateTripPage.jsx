...
import { generatePrompt, getToken } from "../util";
...
const CreateTripPage = () => {
    ...
    const fetchSuggestions = async () => {
        const detinations = inputs?.destinations;
        const message = generatePrompt(detinations);
        const url = 'https://api.openai.com/v1/chat/completions';
        const token = config.AI_API_TOKEN;
                ...
                >
                    ...
                    <Box component="form" width='100%'>
                        <Stack spacing={2}>
                            ...
                            {isEmpty(suggestion) ||
                                <ShowSuggestion text={suggestion} />
                            }
